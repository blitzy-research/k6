...
func getConsolidatedConfig(gs *state.GlobalState, cliConf Config, runnerOpts lib.Options) (conf Config, err error) {
	...
	// (threshold validation omitted for brevity)
	return conf, nil
}
```
